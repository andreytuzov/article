...
<div class="container"> 
	...
	<form id="dealForm" class="form-horizontal" action="/motordepot/page?action=modify_deal" method="post" novalidate>
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<div class="input-group date" id="dateFromPicker">
					...
					<input type="text" autofocus required class="form-control" name="dateFrom" value="${deal.dateFrom}">
