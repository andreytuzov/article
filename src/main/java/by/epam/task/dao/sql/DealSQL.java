...
public class DealSQL {
	...
	public static final int INDEX_DEAL_ID = 8;
	...
	public static final String INSERT_DEAL = "INSERT INTO deals(d_user_id, d_car_id, d_deal_state_id, d_bill, d_date_from, d_date_to, d_description)" 
			+ " VALUES(?, ?, ?, ?, ?, ?, ?)";
	public static final String DELETE_DEAL = "SELECT * FROM deals WHERE d_id = ?";
	public static final String UPDATE_DEAL = "UPDATE deals "
			+ " SET d_user_id = ?, d_car_id = ?, d_deal_state_id = ?, d_bill = ?, d_date_from = ?, d_date_to = ?, d_description = ?"
			+ " WHERE d_id = ?";
